...
import { Text } from "@/v-annotator/domain/models/Label/Text";
import {
  Label,
  LabelList,
  EntityLabelListItem,
  RelationLabelListItem,
} from "@/v-annotator/domain/models/Label/Label";
import { Entities, Entity } from "@/v-annotator/domain/models/Label/Entity";
import { Font } from "@/v-annotator/domain/models/Line/Font";
import { widthOf } from "@/v-annotator/domain/models/Line/Utils";
import { LineWidthManager } from "../domain/models/Line/WidthManager";
import { TextLine } from "@/v-annotator/domain/models/Line/LineText";
import { TextLineSplitter } from "@/v-annotator/domain/models/Line/LineSplitter";
import { TextSelector } from "@/v-annotator/domain/models/EventHandler/TextSelectionHandler";
import { Relation, RelationList } from "@/v-annotator/domain/models/Label/Relation";
