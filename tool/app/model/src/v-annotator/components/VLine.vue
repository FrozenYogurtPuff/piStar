...
import { Entity } from "@/v-annotator/domain/models/Label/Entity";
import { RelationListItem } from "@/v-annotator/domain/models/Label/Relation";
import { Font } from "@/v-annotator/domain/models/Line/Font";
import { LabelList } from "@/v-annotator/domain/models/Label/Label";
...
import { EntityLine, GeometricEntity } from "@/v-annotator/domain/models/Line/LineEntity";
import { RelationLine, LineRelation } from "@/v-annotator/domain/models/Line/LineRelation";
