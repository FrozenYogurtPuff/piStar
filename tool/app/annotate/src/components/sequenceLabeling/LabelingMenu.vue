<!-- Cf. https://github.com/doccano/doccano/blob/master/frontend/components/tasks/sequenceLabeling/LabelingMenu.vue -->
...
<script lang="ts">
import type { LabelDTO } from '@/interface/sequence'
