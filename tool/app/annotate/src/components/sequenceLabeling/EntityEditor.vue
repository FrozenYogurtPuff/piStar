<!-- Cf. https://github.com/doccano/doccano/blob/master/frontend/components/tasks/sequenceLabeling/EntityEditor.vue -->
...
import type { SpanDTO } from '@/interface/sequence'
